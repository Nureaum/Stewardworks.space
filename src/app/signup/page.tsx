...
import { Mail, CheckCircle, ChevronLeft, Lock, User, Phone, Eye, EyeOff, FileText, ChevronDown } from 'lucide-react';
    ...
    try {
      ...
      const signUpParams: any = {
        ...
        unsafeMetadata: {
          ...
          terms_signature: signature.trim(),
        }
      };
    ...
    <div className="min-h-screen bg-steward-offwhite flex flex-col items-center justify-center font-exo p-4 py-12 relative z-10">
      <div className="max-w-md w-full bg-white rounded-3xl shadow-xl p-8 md:p-10 border border-gray-100">
        <div className="flex flex-col items-center mb-8">
          ...
          <div className="mt-3 bg-steward-blue/10 border border-steward-blue/30 rounded-lg px-4 py-2 text-xs text-steward-blue font-bold flex items-center gap-1.5">
