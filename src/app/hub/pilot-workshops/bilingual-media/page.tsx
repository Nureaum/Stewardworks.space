...
export default function BilingualMediaPage() {
    ...
    <div className="min-h-screen bg-steward-offwhite p-8 font-exo">
      ...
      <div className="max-w-4xl mx-auto">
        <div className="bg-white rounded-3xl shadow-xl border border-steward-dark/5 overflow-hidden">
          {/* Header */}
          <div className="bg-steward-dark p-12 text-white">
            ...
            <h1 className="text-4xl md:text-5xl font-black uppercase tracking-tight mb-4">Bilingual Media Storytelling</h1>
            <p className="text-xl text-white/80 leading-relaxed">
              Master the art of creating compelling multimedia stories that resonate across languages and cultures.
            </p>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-steward-dark/60 font-bold">April 20, 2026</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-steward-dark/60 font-bold">1:00 PM - 5:00 PM</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-steward-dark/60 font-bold">20 participants</p>
                </div>
              </div>
            ...
            <div className="border-t border-steward-dark/10 pt-8">
              ...
              <ul className="space-y-4">
                <li className="flex items-start gap-3">
                  ...
                  <p className="text-steward-dark/70 font-medium">Storytelling techniques for English and Spanish audiences</p>
                </li>
                <li className="flex items-start gap-3">
                  <div className="w-6 h-6 bg-steward-green rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                    <span className="text-white text-xs font-black">✓</span>
                  </div>
                  <p className="text-steward-dark/70 font-medium">Video editing and audio production basics</p>
                </li>
                <li className="flex items-start gap-3">
                  <div className="w-6 h-6 bg-steward-green rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                    <span className="text-white text-xs font-black">✓</span>
                  </div>
                  <p className="text-steward-dark/70 font-medium">Cultural sensitivity and authentic representation</p>
                </li>
                <li className="flex items-start gap-3">
                  <div className="w-6 h-6 bg-steward-green rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                    <span className="text-white text-xs font-black">✓</span>
                  </div>
                  <p className="text-steward-dark/70 font-medium">Publishing and distributing bilingual content</p>
                </li>
              </ul>
            </div>
