              ...
              <div style={{ display: 'flex', background: 'linear-gradient(180deg,#5b3f29,#4a3220)', borderLeft: '8px solid #3e2a1a', borderRight: '8px solid #3e2a1a', boxShadow: 'inset 0 4px 16px rgba(0,0,0,.5),0 30px 50px -22px rgba(0,0,0,.55)', position: 'relative' }}>
                ...
                <div style={{ width: '140px', flexShrink: 0, borderRight: '6px solid #3e2a1a', display: 'flex' }}>
                  ...
                  <div style={{ flex: 1, display: 'flex', flexDirection: 'column' }}>
                    {/* niche: ocotillo */}
                    <div onClick={() => router.push('/hub/environmental-literacy')} onMouseEnter={() => setHovOco(true)} onMouseLeave={() => setHovOco(false)} style={{ flex: 1, borderBottom: '6px solid #3e2a1a', position: 'relative', display: 'flex', alignItems: 'flex-end', justifyContent: 'center', paddingBottom: '16px', minHeight: '170px', overflow: 'hidden', cursor: 'pointer' }}>
                    ...
                    <div onClick={() => router.push('/hub/environmental-literacy')} onMouseEnter={() => setHovRattle(true)} onMouseLeave={() => setHovRattle(false)} style={{ flex: 1, position: 'relative', display: 'flex', alignItems: 'flex-end', justifyContent: 'center', paddingBottom: '16px', minHeight: '170px', overflow: 'hidden', cursor: 'pointer' }}>
                      <div style={{ position: 'absolute', top: '12px', left: '11px', right: '11px', bottom: '11px', borderRadius: '54px 54px 5px 5px', background: 'linear-gradient(180deg,#33210f,#1d1106)', boxShadow: 'inset 0 10px 20px rgba(0,0,0,.6)', border: '1px solid rgba(231,205,134,.12)' }}></div>
                      <div style={{ position: 'absolute', top: '50%', left: '50%', transform: 'translate(-50%,-56%)', zIndex: 0, fontFamily: '"Courier New", monospace', fontWeight: 700, fontSize: '92px', lineHeight: 1, color: 'rgba(231,205,134,.10)', textShadow: '0 2px 0 rgba(0,0,0,.5),0 -1px 0 rgba(255,255,255,.05)', pointerEvents: 'none' }}>3</div>
                ...
                <div style={{ width: '140px', flexShrink: 0, borderLeft: '6px solid #3e2a1a', display: 'flex', flexDirection: 'row-reverse' }}>
                  ...
                  <div style={{ flex: 1, display: 'flex', flexDirection: 'column' }}>
                    ...
                    <div onClick={() => router.push('/hub/environmental-literacy')} onMouseEnter={() => setHovAlmanac(true)} onMouseLeave={() => setHovAlmanac(false)} style={{ flex: 1, borderBottom: '6px solid #3e2a1a', position: 'relative', display: 'flex', alignItems: 'flex-end', justifyContent: 'center', paddingBottom: '16px', minHeight: '170px', overflow: 'hidden', cursor: 'pointer' }}>
                      <div style={{ position: 'absolute', top: '12px', left: '11px', right: '11px', bottom: '11px', borderRadius: '54px 54px 5px 5px', background: 'linear-gradient(180deg,#33210f,#1d1106)', boxShadow: 'inset 0 10px 20px rgba(0,0,0,.6)', border: '1px solid rgba(231,205,134,.12)' }}></div>
                      <div style={{ position: 'absolute', top: '50%', left: '50%', transform: 'translate(-50%,-56%)', zIndex: 0, fontFamily: '"Courier New", monospace', fontWeight: 700, fontSize: '92px', lineHeight: 1, color: 'rgba(231,205,134,.10)', textShadow: '0 2px 0 rgba(0,0,0,.5),0 -1px 0 rgba(255,255,255,.05)', pointerEvents: 'none' }}>3</div>
                      <div style={{ position: 'relative', zIndex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                    ...
                    <div onClick={() => router.push('/hub/environmental-literacy')} onMouseEnter={() => setHovGlobe(true)} onMouseLeave={() => setHovGlobe(false)} style={{ flex: 1, position: 'relative', display: 'flex', alignItems: 'flex-end', justifyContent: 'center', paddingBottom: '16px', minHeight: '170px', overflow: 'hidden', cursor: 'pointer' }}>
                      <div style={{ position: 'absolute', top: '12px', left: '11px', right: '11px', bottom: '11px', borderRadius: '54px 54px 5px 5px', background: 'linear-gradient(180deg,#33210f,#1d1106)', boxShadow: 'inset 0 10px 20px rgba(0,0,0,.6)', border: '1px solid rgba(231,205,134,.12)' }}></div>
                      <div style={{ position: 'absolute', top: '50%', left: '50%', transform: 'translate(-50%,-56%)', zIndex: 0, fontFamily: '"Courier New", monospace', fontWeight: 700, fontSize: '92px', lineHeight: 1, color: 'rgba(231,205,134,.10)', textShadow: '0 2px 0 rgba(0,0,0,.5),0 -1px 0 rgba(255,255,255,.05)', pointerEvents: 'none' }}>3</div>
                      <div style={{ position: 'relative', zIndex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
