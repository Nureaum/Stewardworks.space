...
import GoldLoader from '@/components/hub/GoldLoader'

export default function ClientEnvPage({ initialData }: { initialData: { topics: any[], blocks: any[] } }) {
  const [topics, setTopics] = useState<any[]>(initialData.topics);
  ...
  // Removed loading check since it's server-rendered
