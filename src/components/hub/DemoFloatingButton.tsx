...
export default function DemoFloatingButton({ onClick }: DemoFloatingButtonProps) {
  return (
    <button
      onClick={onClick}
      className="fixed bottom-6 right-6 z-[90] flex items-center justify-center gap-2 px-5 h-[46px] bg-[#f0c05a] hover:bg-[#f5cf7a] rounded-full shadow-[0_5px_20px_rgba(240,192,90,0.5)] transition-all animate-bounce group border-2 border-white/20"
      title="Watch Demo"
    >
