...
function hum(
  ...
  return [
    ...(extra || []),
    // legs + shoes
    [10, 22, 3, 5, pant], [15, 22, 3, 5, pant],
    [10, 22, 1, 5, pS], [15, 22, 1, 5, pS],
    [9, 21, 10, 1, pant], [9, 20, 10, 1, 'AD'],
    [9, 27, 5, 1, shoe], [14, 27, 5, 1, shoe],
    [9, 26, 4, 1, shoeHi], [15, 26, 4, 1, shoeHi],
    // torso (shirt = accent)
    [8, 13, 12, 1, 'A'], [7, 14, 14, 7, 'A'],
    [7, 14, 2, 7, 'AD'], [19, 14, 2, 7, 'AD'],
    [7, 20, 14, 1, 'AD'], [12, 13, 4, 1, 'AD'],
    // sleeves + arms
    [6, 14, 2, 4, 'A'], [20, 14, 2, 4, 'A'],
    [6, 15, 1, 3, 'AD'], [21, 15, 1, 3, 'AD'],
    [6, 18, 2, 3, 'SK'], [20, 18, 2, 3, 'SK'],
    [6, 18, 1, 3, 'SD'], [21, 18, 1, 3, 'SD'],
    [6, 21, 2, 1, 'SD'], [20, 21, 2, 1, 'SD'],
    // neck
    ...
    // signature hair (HR/HD)
    ...hairR,
    // brows + eyes
    [11, 5, 2, 1, 'HD'], [15, 5, 2, 1, 'HD'],
    [11, 6, 2, 2, _wht], [15, 6, 2, 2, _wht],
    [12, 6, 1, 2, _eye], [16, 6, 1, 2, _eye],
    // nose + cheeks
    [13, 8, 1, 1, 'SD'], [10, 8, 1, 1, 'SD'], [17, 8, 1, 1, 'SD'],
    // mouth
    [12, 9, 4, 1, _mth], [13, 10, 2, 1, darken(_mth, 0.3)],
  ]
}
...
export const CHARACTERS: Record<string, CharacterDef> = {
  nayeli: { key: 'nayeli', name: 'NAYELI', kind: 'Steward', people: true, skinDefault: '#f0c090',
    rects: hum('#f0c090', '#3a241f', [[10,2,8,2,'HR'],[9,3,10,1,'HR'],[13,1,3,1,'HR'],[9,4,1,7,'HR'],[18,4,1,7,'HR'],[8,5,1,6,'HR'],[19,5,1,6,'HR'],[10,3,8,1,'HD'],[8,10,2,1,'HR'],[18,10,2,1,'HR']], '#3a2f6a') },
  mateo: { key: 'mateo', name: 'MATEO', kind: 'Steward', people: true, skinDefault: '#a56a43',
    rects: hum('#a56a43', '#1c120a', [[10,2,8,1,'HR'],[9,3,10,1,'HR'],[9,4,1,3,'HR'],[18,4,1,3,'HR'],[10,3,8,1,'HD']], '#2a2550') },
  sam: { key: 'sam', name: 'SAM', kind: 'Steward', people: true, skinDefault: '#d99a6a',
    rects: hum('#d99a6a', '#241812', [[10,2,8,1,'HR'],[9,3,9,1,'HR'],[16,2,3,2,'HR'],[9,4,1,3,'HR'],[18,4,1,4,'HR'],[10,3,7,1,'HD']], '#3a2f6a') },
  ...
  quest: { key: 'quest', name: 'VALE', kind: 'Valley Quest Hero', people: true, skinDefault: '#e8b088',
    rects: hum('#e8b088', '#3a1a4a', [[10,2,8,1,'HR'],[9,3,10,1,'HR'],[11,1,1,2,'HR'],[13,1,1,2,'HR'],[15,1,1,2,'HR'],[9,4,1,4,'HR'],[18,4,1,4,'HR'],[10,2,8,1,'HD']], '#5a3f9a', [[3,12,2,11,'#ff5fd2'],[23,12,2,11,'#ff5fd2'],[5,21,18,2,'#ff5fd2'],[9,1,1,1,'#ffd23f'],[13,0,1,1,'#ffd23f'],[18,1,1,1,'#ffd23f'],[10,0,8,1,'#ffd23f']]) },
